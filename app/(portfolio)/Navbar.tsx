...
export default function Navbar() {
  ...
  return (
    <div className="flex space-x-1 rounded-2xl border border-black/20 p-1 backdrop-blur backdrop-brightness-125 dark:border-white/20 dark:backdrop-brightness-90">
