  ...
  return (
    <div className="group relative flex h-full flex-col justify-between rounded-3xl bg-(--surface-color) p-8 drop-shadow-sm duration-300 hover:scale-[1.01] hover:drop-shadow-md sm:p-10">
      ...
      <div>
        ...
        <blockquote className="text-sm leading-relaxed text-(--secondary) duration-300 group-hover:text-(--primary) sm:text-base">
          {quote}
        </blockquote>
      </div>
      <div className="mt-4 border-t border-(--border-color) pt-4 sm:mt-6 sm:pt-6">
        <p className="font-semibold tracking-wide text-(--primary) sm:text-lg">
          {author}
        </p>
