...
export default function QuoteCard({
  ...
  return (
    <div className="relative flex h-full flex-col justify-between rounded-2xl bg-[--background-color] px-8 py-6 drop-shadow sm:px-10 sm:py-8 dark:bg-[--banner-color]">
