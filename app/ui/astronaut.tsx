  ...
  return (
    <div className="relative h-[340px] animate-spin-slow md:h-auto">
      <div className="absolute left-1/2 top-1/2 h-[300px] w-[250px] -translate-x-1/2 -translate-y-1/2">
        {/* Oxygen tank */}
        <div className="absolute left-1/2 top-1/2 h-[150px] w-[100px] -translate-x-1/2 -translate-y-1/2 rounded-t-full bg-slate-500" />
        ...
        <div className="absolute left-1/2 top-[34px] h-[80px] w-[97px] -translate-x-1/2 bg-gradient-to-r from-slate-300 to-slate-100 [border-radius:50%]">
          <div className="absolute -left-1 top-1/2 h-[25px] w-[12px] -translate-y-1/2 rounded-xl bg-cyan-700 shadow-[92px_0_0_theme('colors.cyan.600')]" />
          <div className="absolute left-1/2 top-1/2 h-[50px] w-[60px] -translate-x-1/2 -translate-y-1/2 rounded-xl bg-gradient-to-b from-cyan-400 to-sky-700" />
        </div>
        ...
        <div className="absolute left-1/2 top-[105px] z-10 h-[100px] w-[85px] -translate-x-1/2 bg-gradient-to-r from-slate-300 to-slate-100 [border-radius:40px/20px]">
          <div className="absolute left-1/2 top-[20px] h-[40px] w-[60px] -translate-x-1/2 bg-gradient-to-t from-cyan-400 to-sky-700">
        ...
        <div className="absolute left-[30px] top-[121px] h-[30px] w-[80px] rounded-bl-[39px] bg-slate-300">
          ...
          <div className="absolute left-0 top-[-24px] h-[10px] w-[30px] bg-cyan-700" />
        </div>
        <div className="absolute right-[30px] top-[121px] h-[30px] w-[80px] rounded-br-[39px] bg-slate-100">
          ...
          <div className="absolute right-0 top-[-24px] h-[10px] w-[30px] bg-cyan-600" />
        </div>

        {/* Legs */}
        <div className="absolute bottom-[70px] left-[75px] h-[40px] w-[30px] rotate-[20deg] bg-slate-300">
          <div className="absolute bottom-[-24px] left-[-20px] h-[30px] w-[50px] rounded-tl-3xl border-b-[10px] border-cyan-700 bg-slate-300" />
        </div>
        <div className="absolute bottom-[70px] right-[75px] h-[40px] w-[30px] rotate-[-20deg] bg-slate-100">
          <div className="absolute bottom-[-24px] right-[-20px] h-[30px] w-[50px] rounded-tr-3xl border-b-[10px] border-cyan-600 bg-slate-100" />
        </div>
      </div>
    </div>
  );
