    ...
    <div className="group subtle-border relative size-72 shrink-0 rounded-xl bg-(--overlay-color)">
      <div className="-inset-[1px] group-hover:-translate-x-3.5 group-hover:-translate-y-3.5 subtle-border pointer-events-none absolute rounded-xl bg-(--background-color) duration-[400ms] ease-in-out">
        ...
        <div className="absolute inset-0 transition-transform duration-700 [transition-timing-function:ease-in-out] group-hover:translate-x-[12%] group-hover:translate-y-[12%] group-hover:rotate-180 group-hover:scale-[60%] group-hover:delay-200">
          <div className="-rotate-[16deg] glass-effect top-[50%] left-[70%] flex size-14 items-center justify-center rounded-[1.25rem] backdrop-blur-xs">
            <div className="size-1/2 opacity-70 invert-0 dark:opacity-90 dark:invert">
              <Image src="/nextjs.svg" fill alt="Nextjs logo" />
            </div>
          </div>
          <div className="glass-effect -rotate-[16deg] top-[65%] left-[45%] flex size-14 items-center justify-center rounded-[1.25rem] backdrop-blur-xs">
            <div className="size-5/12 opacity-70 invert-0 dark:opacity-90 dark:invert">
              <Image src="/typescript.svg" fill alt="Typescript logo" />
            </div>
          </div>
          <div className="glass-effect top-[36%] left-[46%] flex size-14 rotate-[16deg] items-center justify-center rounded-[1.25rem] backdrop-blur-xs">
            <div className="size-7/12 opacity-70 invert-0 dark:opacity-90 dark:invert">
              <Image src="/react.svg" fill alt="React logo" />
            </div>
          </div>
          <div className="glass-effect -rotate-[33deg] top-[48%] left-[29%] flex size-7 items-center justify-center rounded-xl backdrop-blur-xs">
            <div className="size-7/12 opacity-70 invert-0 dark:opacity-90 dark:invert">
              <Image src="/tailwindcss.svg" fill alt="Tailwindcss logo" />
            </div>
          </div>
          <div className="glass-effect top-[68%] left-[64%] flex size-7 rotate-[20deg] items-center justify-center rounded-xl backdrop-blur-xs">
            <div className="size-1/2 opacity-70 invert-0 dark:opacity-90 dark:invert">
              <Image src="/kotlin.svg" fill alt="Kotlin logo" />
            </div>
          </div>
          <div className="glass-effect -rotate-[21deg] top-[28%] left-[68%] flex size-7 items-center justify-center rounded-xl backdrop-blur-xs">
            <div className="size-7/12 opacity-70 invert-0 dark:opacity-90 dark:invert">
