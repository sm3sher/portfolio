...
export default function Button({ children, onClick }: Props) {
  return (
    ...
    >
      ...
      <span className="relative flex w-full items-center justify-center gap-2 text-left transition-colors duration-200 ease-in-out group-hover:text-[--background-color]">
        {children}
      </span>
